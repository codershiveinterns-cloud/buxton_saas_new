  ...
  return (
    <div className="bg-white rounded-xl border border-[#E5DED6] shadow-sm overflow-hidden h-full">
      ...
      <div className="p-6 flex-1 overflow-y-auto">
        <div className="relative border-l-2 border-[#2563EB] ml-4 space-y-8 py-4">
          
          {/* Project Start */}
          <div className="relative">
            <div className="absolute -left-[25px] bg-[#2563EB] w-12 h-12 rounded-full border-4 border-white flex items-center justify-center mt-1">
               <Flag className="w-5 h-5 text-white" />
            </div>
            <div className="ml-10 bg-[#EFE9E1] p-4 rounded-xl border border-[#E5DED6]">
          ...
          {tasks.map((task) => (
            <div key={task._id} className="relative">
               <div className={`absolute -left-[13px] w-6 h-6 rounded-full border-4 border-white mt-1 ${
                 task.status === 'Completed' ? 'bg-green-500' : 'bg-[#E5DED6]'
               }`} />
               <div className="ml-8 p-4 rounded-xl border border-[#E5DED6] bg-white hover:shadow-md transition-shadow">
